...
Filename: "{cmd}"; Parameters: "/C schtasks /Run /TN ""Vitakora Server"""; Flags: runhidden waituntilterminated
Filename: "{app}\Client\Vitakora.Client.exe"; Description: "Abrir Vitakora"; Flags: nowait postinstall skipifsilent

[UninstallRun]
Filename: "{cmd}"; Parameters: "/C schtasks /End /TN ""Vitakora Server"" >nul 2>&1 & schtasks /Delete /TN ""Vitakora Server"" /F >nul 2>&1 & netsh advfirewall firewall delete rule name=""Vitakora Server"" >nul 2>&1 & netsh advfirewall firewall delete rule name=""Vitakora Discovery"" >nul 2>&1"; Flags: runhidden waituntilterminated
